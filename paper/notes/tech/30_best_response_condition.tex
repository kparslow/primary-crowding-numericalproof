...
\begin{remark*}
The log form can be numerically convenient: it converts the multiplicative gain--cost comparison
into an additive inequality. This is often more stable in simulations when probabilities are close
to $0$ or $1$.
\end{remark*}
